...
module VCAP::Services::Base::AsyncJob::Backup
  describe DBClient do
    ...
    it "should set, get & delete single backup info" do
      backup_id = "1"
      msg = {"test" => 1}
      DBClient.set_single_backup_info(backup_id, msg)
      DBClient.get_single_backup_info(backup_id).should == msg
      DBClient.delete_single_backup_info(backup_id)
      DBClient.get_single_backup_info(backup_id).should == nil
    end
    ...
    it "should be able to handle nil or invalid value" do
      ...
      expect { DBClient.set_single_backup_info(nil, {}) }.not_to raise_error
      DBClient.get_single_backup_info(nil).should == nil
      expect { DBClient.delete_single_backup_info(nil) }.not_to raise_error
      ...
      backup_id = "2"
      DBClient.set_single_backup_info(backup_id, invalid_msg)
      DBClient.get_single_backup_info(backup_id).should == nil
    end
  end
