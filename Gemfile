...
group :test do
  ...
  gem 'vcap_services_messages', :git => 'https://github.com/vchs/vcap-services-messages.git', :ref => '470cd3f0f0bd8'
  gem 'vcap_injection', :git => 'https://github.com/vchs/vcap-injection.git'
