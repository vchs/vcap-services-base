...
group :test do
  ...
  #gem 'vcap_services_messages', :git => 'https://github.com/vchs/vcap-services-messages.git', :ref => '3bdc81cec3'
  ...
  gem 'vcap_services_messages', :path => '/Users/hgadgil/github/vchs/vcap-services-messages', :ref => '470e2e6c5d3'
end
