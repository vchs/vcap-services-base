    ...
    if plan_nodes.count > 0
      ...
      if version_nodes.count > 0
        ...
        if best_nodes.size > 0 && ( allow_over_provisioning ||
          ...
          # "configuration" contains any data that need persistent when gateway restart such as versionm, plan
          # and peers topology for a given service instance.
          # The base code requires configuration contains a Array of peer credentails called "peers".
