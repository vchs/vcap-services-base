...
module VCAP::Services::Base::ProvisionerV3
      ...
      if version_nodes.count > 0
        ...
        if best_nodes.size > 0 && ( allow_over_provisioning ||
          ...
          if is_restoring
            ...
            raise "original instance #{original_instance_id} not found" unless original_instance_handle
            original_creds = original_instance_handle[:credentials]
            raise "credentials for original instance #{original_instance_id} not found" unless original_creds
          end
          ...
          if is_restoring
            ...
            peers.each do |peer|
              ...
              result = restore_backup(service_id, backup_id, node_id, restore_opts)
  ...
  def restore_backup(service_id, backup_id, node_id, opts)
